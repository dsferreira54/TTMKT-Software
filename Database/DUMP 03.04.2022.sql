CREATE DATABASE  IF NOT EXISTS `ttmktdatabase` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ttmktdatabase`;
...
INSERT INTO `marca` VALUES ('M1','1234-1234','email@email','KiBoa'),('M2','1234-1234','email@email','Comfort'),('M3','1234-1234','email@email','Bauduco');
...
-- Dump completed on 2022-04-03 20:02:09
